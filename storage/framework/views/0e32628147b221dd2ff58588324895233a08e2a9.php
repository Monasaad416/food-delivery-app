				...
				<div class="table-responsive hoverable-table">
                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('إضافة-منطقة')): ?>
                        <button id="button" class="btn btn-primary mg-b-20">
                            <a href="<?php echo e(route('regions.create')); ?>" class="text-white">
                                إضافة منطقة
                            </a>
                        </button>
                    <?php endif; ?>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content tx-size-sm">
            <div class="modal-body tx-center pd-y-20 pd-x-20">
                ...
                <form action="<?php echo e(route('region.delete')); ?>" method="post" autocomplete="off">
                    <?php echo csrf_field(); ?>
                    <div class="form-row">
                        <div class="col">
...
<?php $__env->startPush('scripts'); ?>
    ...
    $(function() {
        $('#regions').DataTable({
            processing: true,
            serverSide: true,
            ajax: '<?php echo route('regions.list'); ?>',
            columns: [
                { data: 'id', name: 'id' },
                { data: 'name', name: 'name' },
...
<?php echo $__env->make('dashboard.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravelprojects\sofra-app\resources\views/dashboard/pages/regions/index.blade.php ENDPATH**/ ?>