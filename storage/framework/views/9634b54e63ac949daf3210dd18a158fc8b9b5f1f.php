<?php $__env->startSection('page-header'); ?>
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"><a href="<?php echo e(route('home')); ?>">الرئيسية</a></h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ المطاعم</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
...
<div class="modal" id="change_restaurant_availability_modal">
    <div class="modal-dialog" role="document">
        <div class="modal-content modal-content-demo">
            ...
            <form action="<?php echo e(route('restaurant.change_availability')); ?>" method="post" autocomplete="off">
                <?php echo csrf_field(); ?>
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content tx-size-sm">
            <div class="modal-body tx-center pd-y-20 pd-x-20 mx-3 my-3">
                ...
                <h6 class="tx-danger mg-b-20">هل أنت متأكد من عملية الحذف لمطعم  <span id="name"></span></h6>

                <form action="<?php echo e(route('restaurant.delete')); ?>" method="post" autocomplete="off">
                    <?php echo csrf_field(); ?>
                    <div class="form-row">
                        <div class="col">
                            <input type="hidden" id="id" name="id">
...
<?php $__env->startPush('scripts'); ?>
    ...
    $(function() {
        $('#restaurants').DataTable({
            ...
            dom: 'Bfrtip',
            buttons: ['print'],
            ajax: '<?php echo route('restaurants.list'); ?>',
            columns: [
                { data: 'id', name: 'id' },
                { data: 'name', name: 'name' },
...
<?php echo $__env->make('dashboard.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravelprojects\sofra-app\resources\views/dashboard/pages/restaurants/index.blade.php ENDPATH**/ ?>