                        ...
                        <?php echo Form::model($user,[
                            'route' => ['dashboard.users.update',$user->id],
                             'method' => 'PATCH',
                                ...
                                <div class="col-xs-12 col-sm-12 col-md-12">
                                    <div class="form-group">
                                        <?php echo Form::select('roles_name[]', $roles,$user->roles_name, array('class' => 'form-control','multiple')); ?>
...
<?php echo $__env->make('dashboard.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravelprojects\sofra-app\resources\views/dashboard/pages/users/edit.blade.php ENDPATH**/ ?>