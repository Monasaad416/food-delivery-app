<?php $__env->startSection('page-header'); ?>
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="content-title mb-0 my-auto"><a href="<?php echo e(route('home')); ?>">الرئيسية</a></h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/ الطلبات</span>
            </div>
        </div>
    </div>
    <!-- breadcrumb -->
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content tx-size-sm">
            <div class="modal-body tx-center pd-y-20 pd-x-20">
                ...
                <form action="<?php echo e(route('order.delete')); ?>" method="post" autocomplete="off">
                    <?php echo csrf_field(); ?>
                    <div class="form-row">
                        <div class="col">
...
<?php $__env->startPush('scripts'); ?>
    ...
    $(function() {
        ...
        $('#orders').DataTable({
            ...
            dom: 'Bfrtip',
            buttons: ['print'],
            ajax: '<?php echo route('orders.list'); ?>',
            columns: [
                { data: 'id', name: 'id' },
...
<?php echo $__env->make('dashboard.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\laravelprojects\sofra-app\resources\views/dashboard/pages/orders/index.blade.php ENDPATH**/ ?>