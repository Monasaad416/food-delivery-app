			...
			<div class="main-sidemenu">
				...
				<ul class="side-menu">
					...
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='chart-morris') }}">قائمة المطاعم</a></li> 
							<li><a class="slide-item" href="{{ url('/' . $page='chart-flot') }}">إضافة مطعم</a></li>
						</ul>
					</li>
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='products') }}">قائمة العملاء</a></li>
						</ul>
					</li>
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='cards') }}">الطلبات المعلقة</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='darggablecards') }}">الطلبات المقبولة</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='rangeslider') }}">الطلبات المرفوضة</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='calendar') }}">الطلبات التي تم تسليمها</a></li>
							<li><a class="slide-item" href="{{ url('/' . $page='contacts') }}">الطلبات الي تم استرجاعها</a></li>
						</ul>
					</li>
	
					<li class="slide">
						<a class="side-menu__item" data-toggle="slide" href="{{ url('/' . $page='#') }}"><svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24"><path d="M0 0h24v24H0V0z" fill="none"/><path d="M13 4H6v16h12V9h-5V4zm3 14H8v-2h8v2zm0-6v2H8v-2h8z" opacity=".3"/><path d="M8 16h8v2H8zm0-4h8v2H8zm6-10H6c-1.1 0-2 .9-2 2v16c0 1.1.89 2 1.99 2H18c1.1 0 2-.9 2-2V8l-6-6zm4 18H6V4h7v5h5v11z"/></svg><span class="side-menu__label">البنوك</span><i class="angle fe fe-chevron-down"></i></a>
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='form-elements') }}">قائمة البنوك</a></li>
						</ul>
					</li>
					<li class="slide">
						...
						<ul class="slide-menu">
							<li><a class="slide-item" href="{{ url('/' . $page='table-basic') }}">قائمة المحافظات</a></li>
						</ul>
					</li>
                    <li class="slide">
